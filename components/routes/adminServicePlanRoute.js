...
const { createServicePlan, updateServicePlan, getAllServicePlans, deleteServicePlan } = require('../controllers/adminServicePlanController');
...
router.get('/get-plans', getAllServicePlans); // get all service plans route
